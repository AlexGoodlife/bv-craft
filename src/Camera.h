...
#define camera_init_default() camera_init(vec3(0.0f,0.0f,0.0f), vec3(0.0f,0.0f,1.0f), vec3(0.0f,1.0f,0.0f), DEF_YAW, DEF_PITCH, DEF_FOV, DEF_SENSITIVITY, DEF_SPEED)
#define camera_init_new_default() camera_init_new(vec3(0.0f,0.0f,0.0f), vec3(0.0f,0.0f,1.0f), vec3(0.0f,1.0f,0.0f), DEF_YAW, DEF_PITCH, DEF_FOV, DEF_SENSITIVITY, DEF_SPEED)
